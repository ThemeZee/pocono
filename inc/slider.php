...
function pocono_slider_scripts() {
	...
	if ( true === $theme_options['slider_blog'] or is_page_template( 'template-slider.php' ) ) :
		...
		wp_enqueue_script( 'pocono-slider', get_template_directory_uri() . '/js/slider.js', array( 'jquery-flexslider' ) );

		// Register and enqueue slider CSS.
		wp_enqueue_style( 'pocono-slider', get_template_directory_uri() . '/css/flexslider.css' );
