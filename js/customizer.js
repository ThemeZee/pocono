...
( function( $ ) {
	...
	// Site Title checkbox.
	wp.customize( 'pocono_theme_options[site_title]', function( value ) {
	...
	wp.customize( 'pocono_theme_options[site_description]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Date checkbox.
	wp.customize( 'pocono_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'pocono_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'pocono_theme_options[meta_category]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'pocono_theme_options[meta_comments]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Tags checkbox.
	wp.customize( 'pocono_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'pocono_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
